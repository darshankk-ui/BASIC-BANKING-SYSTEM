<?php  
 ...
 {  
      ...
      $query = "INSERT INTO customers(img,c_name,email,country,balance) VALUES ('$file','$Name','$Email','$Country','$Balance')";  
...
<center> 
    ...
    <form method="post" enctype="multipart/form-data">  
                        <h4><input type="file" name="img" id="img" required  maxlength="20" size="50"/>  
                        </h4><br/>
